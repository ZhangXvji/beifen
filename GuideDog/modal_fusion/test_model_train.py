...
import numpy as np
import multi_swin
from modal_fusion.datasets_abandon import DogDataset
...
test_dataset = DogDataset(annotations_file='/data/tuzy/Guiding_Robot/modal_fusion/datasets/test_data/processed_data/annotations.csv',
