...
class Args:
    def __init__(self) -> None:
        self.epochs, self.learning_rate, self.patience = [100, 1e-4, 4]
        self.batch_size = 64
...
model = multi_swin.MultiSwin(
    input_channels=1, output_classes=128, final_output_classes=20, pretrained=args.pretrained, debug=False).to(
    args.device)
