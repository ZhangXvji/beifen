...
class SharedConfigs(object):
    ...
    def __init__(self, desc="shared config"):
        ...
        parser.add_argument("--multitask", type=str_to_bool, nargs='?', const=True, default=False,
                            help="use car tensor to do multitask")
        parser.add_argument("--pred_bbox", type=str_to_bool, nargs='?', const=True, default=False,
                            help="pred pred_bbox")
        parser.add_argument("--pred_bbox_with_clip_caption", type=str_to_bool, nargs='?', const=True, default=False,
                            help="pred pred_bbox")
        parser.add_argument("--use_trans", type=str_to_bool, nargs='?', const=True, default=False,
                            help="use transformer decoder")
        parser.add_argument("--pred_class", type=str_to_bool, nargs='?', const=True, default=False,
                            help="add a class decoder")
        parser.add_argument("--openset", type=str_to_bool, nargs='?', const=True, default=False,
                            help="test openset risk localization")
        parser.add_argument("--mean_teacher_pred_bbox", type=str_to_bool, nargs='?', const=True, default=False,
                            help="use mean teacher and inpainted images to pred bbox")
        parser.add_argument("--gaze_pred_bbox", type=str_to_bool, nargs='?', const=True, default=False,
                            help="add gaze to pred pred_bbox")
        parser.add_argument("--inpainted_pred_bbox", type=str_to_bool, nargs='?', const=True, default=False,
                            help="add inpainted images to pred different levels of risk")
        parser.add_argument("--fake_gaze", type=str_to_bool, nargs='?', const=True, default=False,
                            help="add fake gaze to pred pred_bbox")
        parser.add_argument("--detr_aug", type=str_to_bool, nargs='?', const=True, default=False,
                            help="use detr augmentation for drama")
